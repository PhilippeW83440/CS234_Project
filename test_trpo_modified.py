...
import gym
import time
#import spinup.algos.trpo as TRPO_algo
...
"""
def trpo_modified(env_fn, actor_critic=core.mlp_actor_critic, ac_kwargs=dict(), seed=0, 
    ...
    for epoch in range(epochs):
        ...
        for t in range(local_steps_per_epoch):
            ...
            #print("Epoch {}: Step {}: action={} reward={} done={}".format(epoch,t, a, r, d)) 
            cumulated_reward += r
            ep_ret += r
            ep_len += 1
        ...
        print("End of Epoch {} reward {}".format(epoch, cumulated_reward))
...
trpo_modified(lambda : gym.make(env), actor_critic=core.mlp_actor_critic, ac_kwargs=dict(hidden_sizes=[hid]*l), gamma=gamma, seed=seed, steps_per_epoch=steps, epochs=epochs,logger_kwargs=logger_kwargs,algo='trpo')
